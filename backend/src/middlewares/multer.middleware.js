...
const storage = multer.diskStorage({
  ...
  //we can change this to a code that generates a unique filename everytime (this can be found out in the documentation of mmulter or i have directly pasted it below )
  //   },
});
