...
import { seeEmpCompletedTask } from "../store/slice/Admin.slice";
import CustomNavBar from "../helper/CustomNavBar";
import Toast from "react-native-toast-message";


const SelectEmpTaskHist = () => {
    ...
    const handleSeeExpence = async () => {
        ...
        const responce = await dispatch(seeEmpCompletedTask({ ToDate: formattedToDate, EmpId: selectedCategory, FromDate: formattedFromDate }))
        if (responce.type === "seeEmpCompletedTask/fulfilled") {
            navigation.navigate("EmpTaskHistDetails", { data: responce.payload })
        }
        else {
            Toast.show({
                type: 'customNotificationError',
                text1: "Error Fetching History",
                visibilityTime: 1000
            });
        }
    }
        ...
        <View style={styles.container}>
            ...
            <Card style={styles.card}>
                <Card.Content>
                    ...
                    />
                    <Button mode="contained" onPress={handleSeeExpence} style={styles.button}>See History</Button>
                </Card.Content>
            </Card>
        </View>
    );
...
export default SelectEmpTaskHist;
