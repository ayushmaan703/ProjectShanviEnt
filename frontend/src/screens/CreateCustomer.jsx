...
import { createCustomer } from "../store/slice/Auth.slice";
...
const CreateCustomer = () => {
    ...
    // const pickImage = () => {
    //     Alert.alert("Customer Image", "Choose an option", [
    ...
    const handleSubmit = async () => {
        ...
        const connectionDetails = form.connectionDetails.trim();
        ...
        if (!contactNo) {
            Toast.show({
                type: "customNotificationError",
                text1: "Contact number is required.",
                visibilityTime: 1000,
            });
            return;
        }
        ...
        if (contactNo.length !== 10) {
            Toast.show({
                type: "customNotificationError",
                text1: "Contact number must be 10 digits.",
                visibilityTime: 1000,
            });
            return;
        }
        ...
        if (!connectionDetails) {
            Toast.show({
                type: "customNotificationError",
                text1: "Connection details are required.",
                visibilityTime: 1000,
            });
            return;
        }
        ...
        if (!form.image) {
            Toast.show({
                type: "customNotificationError",
                text1: "Please upload a customer image.",
                visibilityTime: 1000,
            });
            return;
        }
        ...
        data.append("connectionDetails", connectionDetails);
        data.append("image", {
            uri: form.image.uri,
    ...
    return (
        <View style={styles.container}>
            ...
            <CustomNavBar title="Create Customer" />
            ...
            >
                    ...
                    {form.image ? (
                        <>
                            ...
                            <View style={styles.editBadge}>
                                <FontAwesome6 name="pen" color="#fff" size={12} />
                            </View>
                        </>
                    ) : (
                        <>
                            <FontAwesome6 name="camera" size={36} color="#4A90E2" />
                ...
                >
                    {loading ? (
                        ...
                        <FontAwesome6 name="plus" color="#fff" size={18} />
                    )}
            ...
            <Modal
                ...
                onBackButtonPress={() => setShowImagePicker(false)}
